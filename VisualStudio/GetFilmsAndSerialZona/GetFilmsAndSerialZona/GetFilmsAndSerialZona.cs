...
namespace FilmsAndSerialZona
{
    ...
    {
        /// <summary>
        /// Были бы запрошены данные фильтров на сервере
        /// </summary>
        private static bool GetedFilters;

        /// <summary>
        /// Жанр (1 - ключ 2 - название на русском)
        /// </summary>
        private static string[][] genre;
        /// <summary>
        /// Список жанров на русском
        /// </summary>
        ...
        /// <summary>
        /// Года (1 - ключ 2 - название на русском)
        /// </summary>
        private static string[][] year;
        /// <summary>
        /// Выбор дат на русском
        /// </summary>
        ...
        /// <summary>
        /// Список стран (1 - ключ 2 - название на русском)
        /// </summary>
        ...
        /// <summary>
        /// Фильтр рейтинга (1 - ключ 2 - название на русском)
        /// </summary>
        private static string[][] rating;
        /// <summary>
        /// Фильтр рейтинга на русском
        /// </summary>
        ...
        /// <summary>
        /// Виды сортировок (1 - ключ 2 - название на русском)
        /// </summary>
        private static string[][] sort;
        /// <summary>
        /// Вид сортировки на русском
        /// </summary>
        ...
        /// <summary>
        /// Если True то ищет сериалы иначе ищутся фильмы
        /// </summary>
        ...
        /// <summary>
        /// Установить жанр по русскому названию (указывать в точности как указано в Genre)
        /// </summary>
        ...
        /// <summary>
        /// Установить год по русскому названию (указывать в точности как указано в Year)
        /// </summary>
        ...
        /// <summary>
        /// Установить страну по русскому названию (указывать в точности как указано в Country)
        /// </summary>
        public void SetCountryRus(string NameRus)
        {
            foreach (var elem in country)
            {
                if (elem[1] == NameRus)
        ...
        /// <summary>
        /// Установить рейтинг по русскому названию (указывать в точности как указано в Rating)
        /// </summary>
        public void SetRatingRus(string NameRus)
        {
            foreach (var elem in rating)
            {
                if (elem[1] == NameRus)
        ...
        /// <summary>
        /// Установить сортировку по русскому названию (указывать в точности как указано в Sort)
        /// </summary>
        public void SeSortRus(string NameRus)
        {
            foreach (var elem in sort)
            {
                if (elem[1] == NameRus)
        ...
        /// <summary>
        /// Установить сортировку по индексу
        /// </summary>
